...
public class DataSourceTransactionManager extends AbstractPlatformTransactionManager
	...
	public DataSource getDataSource() {
		return O2MFactory.getO2MDataSource();
	}
	...
	protected Object doGetTransaction() {
		...
		ConnectionHolder conHolder =
		    (ConnectionHolder) TransactionSynchronizationManager.getResource(O2MFactory.getO2MDataSource());
	...
	protected void doBegin(Object transaction, TransactionDefinition definition) {
		...
		try {
			if (txObject.getConnectionHolder() == null ||
				...
				Connection newCon = O2MFactory.getO2MDataSource().getConnection();
			...
			DataSourceUtils.releaseConnection(con, O2MFactory.getO2MDataSource());
	...
	protected Object doSuspend(Object transaction) {
		...
		ConnectionHolder conHolder = (ConnectionHolder)
				TransactionSynchronizationManager.unbindResource(O2MFactory.getO2MDataSource());
		return conHolder;
	}
	...
	protected void doResume(Object transaction, Object suspendedResources) {
		...
		TransactionSynchronizationManager.bindResource(O2MFactory.getO2MDataSource(), conHolder);
	}
